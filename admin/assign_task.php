		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Task Edit</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Edit Tasks</h4>
							<p class="mb-20"></p>
						</div>
					</div>
					<div class="wizard-content">
						<form method="post" action="">
							<section>
								<?php
								$query = mysqli_query($conn, "select * from mytasks where emp_id = '$get_id' ") or die(mysqli_error());
											...
											<div class="pb-20">
												<table class="data-table table stripe hover nowrap">
													...
													<tbody>
														...
														<?php $sql = "SELECT * from mytasks where emp_id = '$get_id'";
								...
								<div class="row">
									...
									<div class="col-md-12 col-sm-12">
										<div class="card-box pd-30 pt-10 height-100-p">
											<h2 class="mb-30 h4">Tasks Available</h2>
											<div class="pb-20">
												<table class="data-table table stripe hover nowrap">
													<thead>
														<tr>
															...
															<th class="table-plus">Task Name</th>
															<th>Task Code</th>
															<th class="datatable-nosort">Assign Task</th>
														</tr>
													</thead>
													<tbody>
														...
														if ($query->rowCount() > 0) {
															...
															foreach ($results as $result) { ?>
																...
																<tr>
																	...
																	<td><?php echo htmlentities($result->TaskDescription); ?></td>
																	<td>
																		<div class="table-actions">
																			<a href="add_task.php?add_task=<?php echo htmlentities($result->id); ?>&id=<?php echo htmlentities($get_id); ?>" data-color="green"><i class="icon-copy dw dw-add"></i></a>
																		</div>
																	</td>
																</tr>
