						...
						<form method="post" action="">
							<section>
								...
								<div class="row">
									...
									<div class="col-md-12 col-sm-12">
										<div class="card-box pd-30 pt-10 height-100-p">
											<h2 class="mb-30 h4">Courses Available</h2>
											<div class="pb-20">
												<table class="data-table table stripe hover nowrap">
													<thead>
														<tr>
															...
															<th class="table-plus">Course Name</th>
															<th>Course Code</th>
															<th class="datatable-nosort">Assign Course</th>
														</tr>
													</thead>
													<tbody>
														...
														if ($query->rowCount() > 0) {
															...
															foreach ($results as $result) { ?>
																...
																<tr>
																	...
																	<td>
																		<div class="table-actions">
																			<a href="add_course.php?add_course=<?php echo htmlentities($result->id); ?>&id=<?php echo htmlentities($get_id); ?>" data-color="green"><i class="icon-copy dw dw-add"></i></a>
																		</div>
																	</td>
																</tr>
