				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						...
						<div class="user-list">
							<ul>
								<?php
		                         $query = mysqli_query($conn,"select * from mycourses ORDER BY mycourses.emp_id desc limit 4") or die(mysqli_error());
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						...
						<div class="user-list">
							<ul>
								<?php
		                         $query = mysqli_query($conn,"select * from students ORDER BY students.SupervisorId desc limit 4") or die(mysqli_error());
		                         while ($row = mysqli_fetch_array($query)) {
		                         $id = $row['studentNo'];
		                             ?>
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						...
						<div class="user-list">
							<ul>
								<?php
		                         $query = mysqli_query($conn,"select * from myresearch ORDER BY myresearch.emp_id desc limit 4") or die(mysqli_error());
		                         while ($row = mysqli_fetch_array($query)) {
		                         $id = $row['emp_id'];
		                             ?>
